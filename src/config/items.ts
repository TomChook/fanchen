...
export const ITEMS: ItemData[] = [
  ...
  { id: 'apprentice-manual', name: '养气入门诀', type: 'manual', rarity: 'uncommon', tier: 1, minRankIndex: 1, baseValue: 120, desc: '最基础的修行功课，多见于外门与学徒传承。', effect: { cultivation: 0.04, insight: 1 }, manualSkillId: 'heart-apprentice' },
  { id: 'manual-ember', name: '离火弹指诀', type: 'manual', rarity: 'uncommon', tier: 1, minRankIndex: 1, baseValue: 150, desc: '将离火压成一线指劲，出手快而狠，是初学术法时最常见的攻伐手段。', effect: { damageMultiplier: 1.62, burn: 2, qiCost: 10 }, manualSkillId: 'spell-ember-art' },
  ...
  { id: 'manual-breath', name: '归息法', type: 'manual', rarity: 'rare', tier: 2, minRankIndex: 2, baseValue: 980, desc: '正规门派才会拿来培养内门弟子的法门。', effect: { cultivation: 0.08, insight: 3 }, manualSkillId: 'heart-breath' },
  { id: 'manual-frost', name: '寒芒凝锋术', type: 'manual', rarity: 'rare', tier: 2, minRankIndex: 2, baseValue: 860, desc: '凝寒为锋，专破敌方气脉，适合稳扎稳打的术法路数。', effect: { damageMultiplier: 1.48, chill: 2, qiCost: 11 }, manualSkillId: 'spell-frost-bloom' },
  { id: 'manual-wind', name: '流风裂帛术', type: 'manual', rarity: 'rare', tier: 2, minRankIndex: 2, baseValue: 920, desc: '以流风斩开护势，擅长先打出破绽，再衔接下一轮攻势。', effect: { damageMultiplier: 1.58, expose: 2, qiCost: 12 }, manualSkillId: 'spell-wind-blade' },
  ...
  { id: 'manual-sect', name: '授业总谱', type: 'manual', rarity: 'epic', tier: 4, minRankIndex: 4, baseValue: 3800, desc: '可大幅提升宗门传功效率，不可能在凡俗市面出现。', effect: { sectTeaching: 0.18, charisma: 1 }, manualSkillId: 'heart-sect' },
  { id: 'manual-tide-mirror', name: '镜潮归元诀', type: 'manual', rarity: 'epic', tier: 4, minRankIndex: 3, baseValue: 4200, desc: '由两门功法互证而悟出的镜潮心法，正常市面上买不到，只能靠自己练出来后誊写。', effect: { cultivation: 0.1, breakthroughRate: 0.04, insight: 4 }, manualSkillId: 'heart-tide-mirror', discoverOnly: true },
  { id: 'manual-ember-tide', name: '潮火连环诀', type: 'manual', rarity: 'epic', tier: 4, minRankIndex: 3, baseValue: 4600, desc: '将归息与离火反复演化后悟出的连环术法，只能靠悟道后再誊写成册。', effect: { damageMultiplier: 1.92, burn: 3, expose: 1, qiCost: 14 }, manualSkillId: 'spell-ember-tide', discoverOnly: true },
  ...
  { id: 'manual-sun', name: '赤阳心法', type: 'manual', rarity: 'legendary', tier: 6, minRankIndex: 5, baseValue: 18000, desc: '真正的天品传承，只会出现在顶级秘境或宗门重库。', effect: { cultivation: 0.12, insight: 6, power: 1.8 }, manualSkillId: 'heart-sun' },
  { id: 'manual-moon', name: '太阴御神诀', type: 'manual', rarity: 'legendary', tier: 6, minRankIndex: 5, baseValue: 19000, desc: '极罕的心法，不可能让凡人随便摸到。', effect: { breakthroughRate: 0.08, charisma: 4, insight: 2 }, manualSkillId: 'heart-moon' },
]
